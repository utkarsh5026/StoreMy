...
from app.catalog.table_info import TableMetadata, IndexInfo, ConstraintInfo
...
class MockDbFile(ABC):
    """Abstract mock DbFile for testing without circular import issues."""
...
class TestCatalog(unittest.TestCase):
    ...
    def test_get_db_file_not_cached(self):
        ...
        # Mock HeapFile to avoid circular import
