...
func executeDropTablePlan(t *testing.T, plan *ddl.DropTablePlan) (*result.DDLResult, error) {
	t.Helper()
...
func TestNewDropTablePlan(t *testing.T) {
	...
	plan := ddl.NewDropTablePlan(stmt, ctx, transCtx)
...
func TestDropTablePlan_Execute_BasicSuccess(t *testing.T) {
	...
	createPlan := ddl.NewCreateTablePlan(stmt, ctx, transCtx)
	...
	dropPlan := ddl.NewDropTablePlan(dropStmt, ctx, transCtx)
...
func TestDropTablePlan_Execute_CascadeMultipleTables(t *testing.T) {
	...
	dropPlan2 := ddl.NewDropTablePlan(statements.NewDropStatement("products", false), ctx, transCtx)
	dropPlan2.Execute()

	dropPlan3 := ddl.NewDropTablePlan(statements.NewDropStatement("orders", false), ctx, transCtx)
	dropPlan3.Execute()
}
