...
//
// This is the fundamental building block for all operators. It implements the HasNext/Next
// pattern with lookahead caching, eliminating duplicate code across all operator implementations.
