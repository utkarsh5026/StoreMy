...
type CatalogReader interface {
	...
	IterateTable(tableID primitives.FileID, tx *transaction.TransactionContext, processFunc func(*tuple.Tuple) error) error
}
...
type CatalogWriter interface {
	...
	InsertRow(tableID primitives.FileID, tx *transaction.TransactionContext, tup *tuple.Tuple) error
	...
	DeleteRow(tableID primitives.FileID, tx *transaction.TransactionContext, tup *tuple.Tuple) error
}
