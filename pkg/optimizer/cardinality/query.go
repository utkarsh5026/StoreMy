...
func (ce *CardinalityEstimator) estimateProject(node *plan.ProjectNode) (int64, error) {
...
func (ce *CardinalityEstimator) estimateSort(node *plan.SortNode) (int64, error) {
	return ce.EstimatePlanCardinality(node.Child)
}
