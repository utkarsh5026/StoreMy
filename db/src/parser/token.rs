...
impl TokenType {
    fn as_str(self) -> &'static str {
        self.sql_keyword_as_str()
            .unwrap_or_else(|| self.type_and_punct_as_str())
    }

    fn sql_keyword_as_str(self) -> Option<&'static str> {
        match self {
            ...
            TokenType::Cascade => Some("CASCADE"),
            TokenType::Restrict => Some("RESTRICT"),
            TokenType::Null => Some("NULL"),
            TokenType::AutoIncrement => Some("AUTO_INCREMENT"),
            ...
            TokenType::Offset => Some("OFFSET"),
            TokenType::Index => Some("INDEX"),
            TokenType::Using => Some("USING"),
            TokenType::Hash => Some("HASH"),
            TokenType::Btree => Some("BTREE"),
            TokenType::Union => Some("UNION"),
            TokenType::Intersect => Some("INTERSECT"),
            TokenType::Except => Some("EXCEPT"),
            ...
            TokenType::Alter => Some("ALTER"),
            TokenType::Column => Some("COLUMN"),
            TokenType::Rename => Some("RENAME"),
            TokenType::To => Some("TO"),
            TokenType::Validate => Some("VALIDATE"),
            TokenType::Valid => Some("VALID"),
            TokenType::Begin => Some("BEGIN"),
            TokenType::Commit => Some("COMMIT"),
            TokenType::Rollback => Some("ROLLBACK"),
            TokenType::Savepoint => Some("SAVEPOINT"),
            TokenType::Release => Some("RELEASE"),
            TokenType::Transaction => Some("TRANSACTION"),
            _ => None,
        }
    }

    fn type_and_punct_as_str(self) -> &'static str {
        match self {
...
// Jump-table lookup via `match`; no runtime HashMap or heap allocation.
...
impl std::str::FromStr for TokenType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match upper_s.as_str() {
            ...
            "CROSS" => Ok(TokenType::Cross),
            "FULL" => Ok(TokenType::Full),
            "OUTER" => Ok(TokenType::Outer),
            "ON" => Ok(TokenType::On),
            "GROUP" => Ok(TokenType::Group),
            "HAVING" => Ok(TokenType::Having),
            "BY" => Ok(TokenType::By),
            ...
            "AS" => Ok(TokenType::As),
            "IN" => Ok(TokenType::In),
            "BETWEEN" => Ok(TokenType::Between),
            "IS" => Ok(TokenType::Is),
            "LIKE" => Ok(TokenType::Like),
            "CASE" => Ok(TokenType::Case),
            "WHEN" => Ok(TokenType::When),
            ...
            "UNIQUE" => Ok(TokenType::Unique),
            "CASCADE" => Ok(TokenType::Cascade),
            "RESTRICT" => Ok(TokenType::Restrict),
            ...
            "CHECK" => Ok(TokenType::Check),
            "CONSTRAINT" => Ok(TokenType::Constraint),
            "REFERENCES" => Ok(TokenType::References),
            "FOREIGN" => Ok(TokenType::Foreign),
            ...
            "ALTER" => Ok(TokenType::Alter),
            "ADD" => Ok(TokenType::Add),
            "COLUMN" => Ok(TokenType::Column),
            "RENAME" => Ok(TokenType::Rename),
            "TO" => Ok(TokenType::To),
            "VALIDATE" => Ok(TokenType::Validate),
            "VALID" => Ok(TokenType::Valid),
            "BEGIN" => Ok(TokenType::Begin),
            "COMMIT" => Ok(TokenType::Commit),
            "ROLLBACK" => Ok(TokenType::Rollback),
            "SAVEPOINT" => Ok(TokenType::Savepoint),
            "RELEASE" => Ok(TokenType::Release),
